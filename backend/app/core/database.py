...
SQLITE_COMPATIBILITY_COLUMNS = {
    ...
    "users": {
        ...
        "phone_verified": "phone_verified BOOLEAN NOT NULL DEFAULT 0",
        "phone_verified_at": "phone_verified_at DATETIME",
        "phone_verification_otp_hash": "phone_verification_otp_hash VARCHAR(255)",
        "phone_verification_expires_at": "phone_verification_expires_at DATETIME",
        "phone_verification_attempts": "phone_verification_attempts INTEGER NOT NULL DEFAULT 0",
        "phone_verification_sent_at": "phone_verification_sent_at DATETIME",
        "sms_alerts_enabled": "sms_alerts_enabled BOOLEAN NOT NULL DEFAULT 0",
