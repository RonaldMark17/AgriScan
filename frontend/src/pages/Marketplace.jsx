...
function CropCard({ crop, onGuide, weatherSummary, t }) {
  return (
    <article
      className={`surface flex h-full flex-col overflow-hidden rounded-lg border transition-shadow ${
        crop.isBestMatch
      ...
      <div className="flex flex-1 flex-col p-4 sm:p-5">
        ...
        <div className="flex flex-col gap-4 min-[440px]:flex-row min-[440px]:items-start min-[440px]:justify-between">
          <div className="flex min-w-0 items-center gap-3 sm:gap-4">
            <div className={`grid h-12 w-12 shrink-0 place-items-center rounded-lg ${crop.isBestMatch ? 'bg-leaf-100 text-leaf-700' : 'bg-leaf-50 text-leaf-600'}`}>
        ...
        <div className={`mt-5 rounded-lg p-4 ${crop.isBestMatch ? 'bg-leaf-50/80' : 'bg-leaf-50/60'}`}>
