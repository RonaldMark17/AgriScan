...
export default function Login() {
  ...
  return (
    <main className="min-h-svh bg-[#f7faf6] p-2 sm:p-5">
      <div className="mx-auto grid min-h-[calc(100svh-1rem)] max-w-7xl overflow-hidden rounded-lg border border-stone-200/90 bg-white shadow-[0_24px_70px_rgba(15,23,42,0.08)] sm:min-h-[calc(100svh-2rem)] lg:grid-cols-[minmax(0,1.08fr)_460px]">
            ...
            <div className="max-w-2xl pb-2">
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-2 xl:max-w-xl">
                {heroFeatures.map(({ icon: Icon, label }) => (
                  <div key={label} className="flex items-center gap-3 rounded-lg border border-white/18 bg-white/10 px-4 py-3 text-white backdrop-blur-sm">
              ...
              <div className="mt-8 grid grid-cols-3 gap-3 xl:max-w-2xl">
                {[
                  ...
                  <div key={value} className="rounded-lg border border-white/16 bg-black/18 px-4 py-4 backdrop-blur-sm">
        ...
        <section className="flex items-center justify-center bg-[#fcfcfa] px-3 py-4 sm:px-8 sm:py-6 lg:px-10">
          <div className="w-full max-w-md">
            <div className="overflow-hidden rounded-lg border border-stone-200 bg-white shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
              <div className="border-b border-stone-100 px-4 pb-5 pt-5 sm:px-7 sm:pt-6">
                ...
                <div className="mt-5 overflow-hidden rounded-lg lg:hidden">
                ...
                <div className="mt-5 rounded-lg border border-leaf-100 bg-leaf-50 px-4 py-4">
              ...
              <form className="px-4 pb-5 pt-5 sm:px-7 sm:pb-7" onSubmit={handleSubmit}>
                <h2 className="text-2xl font-bold tracking-normal text-stone-950 sm:text-3xl">{t('login')}</h2>
                ...
                <button className="btn-primary mt-6 h-14 w-full text-base shadow-[0_14px_28px_rgba(22,163,74,0.24)]" disabled={loading || (captchaRequired && !captchaToken)}>
